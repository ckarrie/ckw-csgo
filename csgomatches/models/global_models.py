...
from csgomatches.models.base_models import BaseParticipant, BaseMatchMap
...
class Map(models.Model):
    ...
    def csMapImageName(self) -> bool:
        return self.ingame_name if self.ingame_name.startswith("de_") and self.ingame_name != "de_" else False
